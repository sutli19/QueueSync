...
export default function Login() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      const res  = await fetch("https://queuesync-1-n89l.onrender.com/api/auth/login", {
        method:  "POST",
      ...
      setTimeout(async () => {
        ...
        if (data.role === "doctor") {
          try {
            const subRes = await fetch("https://queuesync-1-n89l.onrender.com/api/payment/status", {
