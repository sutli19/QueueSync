...
export default function ForgotPassword() {
  ...
  const handleFetchQuestion = async () => {
    ...
    try {
      const res = await fetch("https://queuesync-1-n89l.onrender.com/api/auth/forgot-password/question", {
        method: "POST",
  ...
  const handleVerifyAnswer = async () => {
    ...
    setLoading(true); setStatus({ msg: "", type: "" });
    try {
      const res = await fetch("https://queuesync-1-n89l.onrender.com/api/auth/forgot-password/verify", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const handleReset = async () => {
    ...
    setLoading(true); setStatus({ msg: "", type: "" });
    try {
      const res = await fetch("https://queuesync-1-n89l.onrender.com/api/auth/forgot-password/reset", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
